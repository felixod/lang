...
/**
 * Strings for component 'h5pactivity', language 'ru', branch 'MOODLE_39_STABLE'
 *
 * @package   h5pactivity
...
$string['true'] = 'Верно';
$string['usecontentbank'] = 'Для управления файлами H5P используйте <a href="{$a}" target="_blank">контент-банк (открывается в новом окне) </a>.';
