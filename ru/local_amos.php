...
/**
 * Strings for component 'local_amos', language 'ru', branch 'MOODLE_36_STABLE'
 *
 * @package   local_amos
...
$string['greylistedwarning'] = 'из «серого списка»';
...
$string['morefilteringoptions'] = 'Остальные настройки';
...
$string['timeline'] = 'история изменений';
...
$string['untranslateconfirm'] = '<p>Вы собираетесь удалить существующий перевод строки <code>{$a->stringid}</code>, компонент <code>{$a->component}</code> из всех версий языкового пакета <code>{$a->language}</code>.</p><p>Вы уверены?</p>';
