...
/**
 * Strings for component 'quizaccess_seb', language 'ru', branch 'MOODLE_39_STABLE'
 *
...
$string['seb_allowedbrowserexamkeys'] = 'Разрешенные значения Browser Exam Key';
$string['seb_allowedbrowserexamkeys_help'] = 'В этом поле вы можете ввести разрешенные значения Browser Exam Key для тех версий Safe Exam Browser, которым разрешен доступ к этому тесту. Если значения не заданы, Browser Exam Key не проверяются.';
