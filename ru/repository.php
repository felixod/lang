...
/**
 * Strings for component 'repository', language 'ru', branch 'MOODLE_39_STABLE'
 *
 * @package   repository
...
$string['aliaseschange'] = 'Ссылок/ярлыков, которые используют этот файл в качестве источника: {$a}. Если вы продолжите, то эти ссылки будут преобразованы в настоящие копии.';
