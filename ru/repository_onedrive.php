...
/**
 * Strings for component 'repository_onedrive', language 'ru', branch 'MOODLE_39_STABLE'
 *
...
$string['privacy:metadata:repository_onedrive:searchtext'] = 'Текстовый запрос поиска пользователей репозитория Microsoft OneDrive.';
$string['removetempaccesstask'] = 'Удалить временный доступ для записи из контролируемых ссылок.';
