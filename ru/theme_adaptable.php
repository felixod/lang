...
/**
 * Strings for component 'theme_adaptable', language 'ru', branch 'MOODLE_39_STABLE'
 *
...
$string['customfields'] = 'Настраиваемые поля';
...
$string['enablealertcoursepages'] = 'Включить окно предупреждения на страницах курсов';
$string['enablealertcoursepagesdesc'] = 'Установка этой опции позволит отображать окна предупреждения на страницах курсов';
...
$string['loadtime'] = 'Страница загружена за';
...
$string['sitetitlemaxwidth'] = 'Наибольшая длина имени сайта';
$string['sitetitlemaxwidthdesc'] = 'Установите наибольшую длину области имени сайта';
