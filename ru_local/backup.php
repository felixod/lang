...
$string['copycoursedesc'] = 'Этот курс будет продублирован и помещён в выбранную категорию курса.';
$string['copycoursetitle'] = 'Копировать курс : {$a}';
$string['copyreturn'] = 'Копировать и вернуться';
$string['copyview'] = 'Копировать и перейти';
$string['importgeneralsettings'] = 'Настройки импорта по-умолчанию';
